...
IPSET_NAME="ipv6-for-qbittorrent"
RULE_NAME="Allow-ipv6-for-qbittorrent"
DEST_PORT="61406"
UPDATE_SCRIPT="/etc/custom-scripts/update-ipv6-for-qbittorrent-ipset.sh"
...
# 5. 添加脚本连接到/www/cgi-bin
if [ ! -L "/www/cgi-bin/${UPDATE_SCRIPT##*/}" ]; then
  ln -sf "${UPDATE_SCRIPT}" /www/cgi-bin/
fi
